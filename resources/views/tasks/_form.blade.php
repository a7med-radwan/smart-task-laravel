                    ...
                    <div>
                        ...
                        <div class="flex gap-2 bg-surface-container-low p-1 rounded-lg border border-outline-variant">
                            ...
                            <button type="button" id="btn-medium" onclick="setPriority('medium')"
                                class="flex-1 py-2 rounded-md transition-all bg-white shadow-sm font-bold text-tertiary">Medium</button>
    ...
    <script>
        function setPriority(level) {
            ...
            Object.values(btns).forEach(btn => {
                btn.classList.remove('bg-white', 'text-secondary', 'text-tertiary', 'text-error', 'shadow-sm', 'font-bold');
