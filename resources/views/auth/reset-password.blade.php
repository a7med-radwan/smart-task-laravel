...
<body class="text-on-surface min-h-screen flex items-center justify-center relative overflow-hidden px-4">
    ...
    <div class="w-full max-w-[460px] bg-white border border-outline-variant rounded-2xl shadow-xl p-8 md:p-10 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-body-md text-on-surface-variant mt-2">Choose a strong, secure password for your workspace account.</p>
        </div>
        ...
        <form action="#" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <input class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary font-body-md text-body-md bg-white outline-none transition-all"
                        id="email" type="email" name="email" placeholder="alexander.w@focus.com" value="{{ old('email', $email ?? '') }}" required />
                </div>
            </div>

            <!-- New Password -->
            <div>
                <label class="font-label-md text-label-md text-on-surface-variant block mb-1.5 uppercase tracking-wider text-[11px]" for="password">New Password</label>
                <div class="relative group">
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <button type="button" id="toggle-confirm-password" class="absolute right-3 top-1/2 -translate-y-1/2 text-on-surface-variant/60 hover:text-on-surface focus:outline-none">
